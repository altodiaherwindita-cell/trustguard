...
// cva() takes exactly (base, config) — extra leading strings are discarded
// silently, which also empties VariantProps<typeof buttonVariants> and made
// every <Button variant=...> fail to typecheck.
